...
class DalelElshamTabView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MultiBlocProvider(
      providers: [
        BlocProvider(
          create: (_) => getIt<GetSectionStatusViewModel>()..getSectionStatus("dalel_section"),
        ),
        BlocProvider(
          create: (_) => getIt<GetAllPlaceCategoriesViewModel>()..getAllCategories(),
        ),
        BlocProvider(
          create: (_) => getIt<GetAllPlacesByCategoryViewModel>() ,
        ),
      ],
      child: Scaffold(
        appBar: const CustomAppBar(title: "دليل الاماكن", ),
        body:
            BlocBuilder<
              GetSectionStatusViewModel,
              GetSectionStatusViewModelStates
            >(
